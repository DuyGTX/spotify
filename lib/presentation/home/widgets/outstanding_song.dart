...
class Outstanding extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Padding(
      padding: const EdgeInsets.only(top: 16), // Đẩy xuống 16px
      child: BlocProvider(
        create: (_) =>
            OutstandingSongCubit(sl<GetOutstradingSongUseCase>())
              ..getOutstandingSongs(),
  ...
  Widget _songs(List<SongEntity> songs) {
    return Padding(
      ...
      child: SizedBox(
        height: 270, // ← ✅ Điều chỉnh cao hơn (ảnh + text), tránh overflow
